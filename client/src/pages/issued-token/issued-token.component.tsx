...
import './issued-token.scss';
import TableOrdersComponent from '../../components/table-orders/table-orders.component';
import { FormattedMessage } from 'react-intl';
import Helmet from 'react-helmet';

export class IssuedTokenComponent extends PureComponent<any> {
  render() {
    return (
      <div className="bi-order-book">
        <FormattedMessage id="common.pages.issued-token.title">
          {title => (
            <Helmet>
              <title>{title}</title>
            </Helmet>
...
export default IssuedTokenComponent;
